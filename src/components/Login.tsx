  ...
  return (
    <>
      <div className="flex h-screen w-screen items-center justify-center bg-white text-sm">
        <div>
          <div className="text-center text-xl">Sign in to shokken</div>
          ...
          <form className="m-3 h-auto w-auto rounded-md border border-gray-300 p-3 px-6">
            ...
            <div className="my-3">
              <div className="relative mb-2 w-full">
                ...
                <a href="" className="float-right ml-4">
                  forgot a password?
                </a>
              </div>
              <input
            ...
            <button
              type="button"
              onClick={(_e) => {
                handleOnClick(f, email.current, password.current)
                f.getIsLogin().then((v) => console.log(v))
              }}
              className="btn-primary btn-sm btn mt-2 w-full text-xs"
            >
              login
            </button>
          </form>
